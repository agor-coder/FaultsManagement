...
INSERT INTO ACCOUNT (id,type,active,confirmed,creation_timestamp,login,password,version,email,firstname,surename,phone) 
 VALUES (-2,'Specjalista',0,0,'2020-11-04 18:39:54.340','login1','123456',1,'21@p.pl','Bartłomiej','HyżyS','5367');
INSERT INTO SPECIALIST(id,department) VALUES (-2,'MR3');

INSERT INTO ACCOUNT (id,type,active,confirmed,creation_timestamp,login,password,version,email,firstname,surename,phone) 
VALUES (-3,'Specjalista',0,0,'2020-12-06 18:40:54.340','login2','123456',1,'2@op.pl','Czesław','JakiS','5368');
INSERT INTO SPECIALIST(id,department) VALUES (-3,'ER4');

INSERT INTO ACCOUNT (id,type,active,confirmed,creation_timestamp,login,password,version,email,firstname,surename,phone) 
VALUES (-10,'Specjalista',0,0,'2021-01-06 11:40:54.000','login9','123456',1,'21@wp.pl','Zbigniew','SkwarS','5377');
INSERT INTO SPECIALIST(id,department) VALUES (-10,'ER4');

INSERT INTO ACCOUNT (id,type,active,confirmed,creation_timestamp,login,password,version,email,firstname,surename,phone) 
VALUES (-4,'Przydzielający',0,0,'2020-12-22 15:39:54.340','login3','123456',1,'3@p.pl','Stefan','SmokP','4367');
INSERT INTO ASSIGNER(id,department) VALUES (-4,'MR4');

INSERT INTO ACCOUNT (id,type,active,confirmed,creation_timestamp,login,password,version,email,firstname,surename,phone) 
VALUES (-5,'Przydzielający',0,0,'2020-12-22 16:39:54.340','login4','123456',1,'35@p.pl','Julian','PtakP','4467');
INSERT INTO ASSIGNER(id,department) VALUES (-5,'IR4');

INSERT INTO ACCOUNT (id,type,active,confirmed,creation_timestamp,login,password,version,email,firstname,surename,phone) 
VALUES (-6,'Przydzielający',0,0,'2020-12-22 17:39:54.340','login5','123456',1,'36@p.pl','Piotr','NowyP','4457');
INSERT INTO ASSIGNER(id,department) VALUES (-6,'IR3');

INSERT INTO ACCOUNT (id,type,active,confirmed,creation_timestamp,login,password,version,email,firstname,surename,phone) 
VALUES (-7,'Zgłaszający',0,0,'2020-11-22 12:39:54.340','login6','123456',1,'5@p.pl','Karol','PiszpanZ','4457');
INSERT INTO NOTIFIER(id,emplacement) VALUES (-7,'mistrz elektryk');

INSERT INTO ACCOUNT (id,type,active,confirmed,creation_timestamp,login,password,version,email,firstname,surename,phone) 
VALUES (-8,'Zgłaszający',0,0,'2020-11-22 12:50:54.340','login7','123456',1,'50@p.pl','Marek','KrólZ','4487');
INSERT INTO NOTIFIER(id,emplacement) VALUES (-8,'mistrz maszynowni');

INSERT INTO ACCOUNT (id,type,active,confirmed,creation_timestamp,login,password,version,email,firstname,surename,phone) 
VALUES (-9,'Zgłaszający',0,0,'2020-11-22 12:57:54.340','login8','123456',1,'40@p.pl','Paweł','MolZ','4587');
